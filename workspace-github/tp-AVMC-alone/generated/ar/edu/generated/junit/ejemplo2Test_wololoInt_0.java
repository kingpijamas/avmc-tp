...
public class ejemplo2Test_wololoInt_0 {
    ...
    public void testwololoInt_0() {
        testing.examples.ejemplo2 instance = new testing.examples.ejemplo2();
        
        // Statics Fields Initialization
        // Fields Initialization for 'instance'
        updateValue(instance, "canarywololoIntbs", false);
        updateValue(instance, "canarywololoIntas", false);
        
        // Method Invocation
        Method method = getAccessibleMethod("testing.examples.ejemplo2", "wololoInt", true);
        try {
