...
public class ejemploooTest_wololoInt_0 {
    ...
    public void testwololoInt_0() {
        ar.edu.itba.ayvmc.ejemplooo instance = new ar.edu.itba.ayvmc.ejemplooo();
        // Fields Initialization for 'instance'
        updateValue(instance, "canarywololoInti", false);
        
        // Method Invocation
        Method method = getAccessibleMethod("ar.edu.itba.ayvmc.ejemplooo", "wololoInt", true);
        try {
