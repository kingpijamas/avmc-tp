...
check check_ar_edu_itba_ayvmc_ejemplooo_wololoInt_0  for 0 but  1 java_lang_Object, exactly 1 ar_edu_itba_ayvmc_ejemplooo, exactly 2 JavaPrimitiveIntegerValue,4 int
...
pred ar_edu_itba_ayvmc_ejemplooo_wololoInt_0[
  ...
  (
    (
      ...
      and 
      (
        var_2_i_1=JavaPrimitiveIntegerLiteral0)
    )
    or 
    (
      (
        ...
        (
          ...
          (
            (
              ...
              and 
              (
                var_2_i_2=JavaPrimitiveIntegerLiteral1)
            )
            or 
            (
              (
...
one sig QF {
  ...
  l0_t_2_0: boolean,
  l0_t_2_1: boolean,
  l0_var_2_i_0: JavaPrimitiveIntegerValue,
  l0_var_2_i_1: JavaPrimitiveIntegerValue,
  l0_var_2_i_2: JavaPrimitiveIntegerValue,
  thiz_0: ar_edu_itba_ayvmc_ejemplooo,
